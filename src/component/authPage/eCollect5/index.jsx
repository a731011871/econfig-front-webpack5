...
import { cloneDeep, find, forEach, includes, flatten } from 'lodash';
...
class eCollect5 extends React.PureComponent {
    ...
    componentDidMount = async () => {
        try {
            ...
            const envResult = await authServices.getEnvList(this.props.appId);
            ...
            this.props.changeList(this.props.appId, roleList, projectList);
        } catch (e) {
    ...
    columns = [
        ...
        },
        {
            ...
            render: (envIds, record) => {
                if (
                    includes(
                        ['ecollect_study_role', 'ecollect_app_role'],
                        record.roleType
                    )
                ) {
