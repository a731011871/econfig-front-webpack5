...
class roleProductProjectModal extends React.PureComponent {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            fetching: false,
            selectProject: [],
            projectRequired: true, // 是否必选项目
            storageRequired: true, // 是否必选库房
            selectRoleInfo: {
    ...
    changeRoles = (value, option) => {
        ...
        // } else {
        //     this.setState({ projectRequired: true, selectRoleInfo: roleInfo });
        // }
        ...
        this.setState({
            projectRequired: roleInfo.roleType === 'PI',
            storageRequired: roleInfo.roleType === 'noProjectadmin',
            selectRoleInfo: roleInfo
        });
    };
