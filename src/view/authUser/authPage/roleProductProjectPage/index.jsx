...
class roleProductProjectPage extends React.PureComponent {
    ...
    componentDidMount = async () => {
        ...
        try {
            ...
            const productDataList = await authServices.getCspProductDataList(
                this.props.appId
            );
            const roleList = await authServices.getCspRoleList(
                this.props.appId
            );
            const cspListPvSuperRole = await authServices.getCspListPvSuperRole(
                userProperty
            );
            this.setState({
                ...
                productDataList,
                listPvSuperRole: cspListPvSuperRole,
                loading: false
            });
    ...
    addProduct = record => {
        if (this.props.edit) {
            const selectProductIds = record.productDataIds || [];
            drawerFun({
                title: this.props.intl.formatMessage(
