 ...
 * @LastEditTime: 2020-09-22 16:57:10
 * @LastEditors: lei.zhao
 * @Description: 授权插件Table中授权数据单行渲染
 * @FilePath: /econfig-front/src/view/deptManagement/departmentPage/departmentMemberList/vlolumeAuth/authRow/authRow.jsx
 */
...
function AuthRow(props) {
    const { rowData, roleList, formatMessage } = props;
