...
/**
 * 外部用户邀请
 * 19.3.21 新增去除外部员工所属企业，部门，职位字段
 */

@Form.create()
class ExternalUserReg extends React.PureComponent {
    ...
    async componentWillMount() {
        try{
            ...
            this.setState({languageList, strategy, positionList});
        }catch(e) {
    ...
    FormElement = {
        ...
        accountName: {
            ...
            rules: [
                {
                    pattern: /^[a-zA-Z0-9._-]*$/,
                    message: '用户名不能输入特殊字符或汉字，且不能超过100位!'
                }, 
                {
    ...
    getFormItem = (datas) => {
        ...
        const { verificationNum, verificationDisabled, languageList, strategy, positionList } = this.state;
            ...
            if (!err) {
                ...
                try{
                    await $http.post(urls.createTenantUserByInvite, {
                        ...
                        // areaCode: values.mobile && values.mobile.code && values.errmobile.code.split('-')[0],
                        areaCode: values.mobile && values.mobile.code.split('-')[0],
        ...
        return (
            <React.Fragment>
                ...
                <div className="email-page-content-form">
                    <Form>
                        {
                            this.getFormItem({timeZone: '+8', languageType: 'zh_CN'})
                        }
                        <Col span={6} />
...
export default ExternalUserReg;