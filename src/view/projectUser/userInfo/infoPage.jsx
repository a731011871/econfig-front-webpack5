...
class UserInfo extends React.Component {
    ...
    handleSubmit = e => {
        ...
        form.validateFields(async error => {
            ...
            const oldUserInfo = Object.assign({}, _this.props.memberInfo);
